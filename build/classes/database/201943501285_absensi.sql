...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 12, 2023 at 07:30 PM
...
('admin', 500000),
('cleaning service', 5500000),
('sales', 5000000),
('security', 5500000),
('service advisor', 5500000),
('software developer', 12000000);
...
('rizki wahyudi', 1000, 5000000, 1691082000000);
...
('rizki wahyudi', 'rizki', 'pria', '3206452143', 'service advisor', 'Programming', '083174506600', 'karyawan');
